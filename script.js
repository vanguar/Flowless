...
const I18N = {
  ru: {
    ...
    "nav.services": "Услуги", "nav.approach": "Подход", "nav.contacts": "Контакты",
    "header.cta": "Написать",
    ...
    "toast.error": "Не удалось отправить — открываю почту.",
  ...
  uk: {
    ...
    "nav.services": "Послуги", "nav.approach": "Підхід", "nav.contacts": "Контакти",
    "header.cta": "Написати",
    ...
    "toast.error": "Не вдалося надіслати — відкриваю пошту.",
